...
struct ledd_subsystem_class {
     ...
     * parent struct locl_subsystem, and return pointer to parent.
     *
     * @return pointer to allocated subsystem.
     */
    struct locl_subsystem *(*ledd_subsystem_alloc)(void);
     ...
     */
    int (*ledd_subsystem_construct)(struct locl_subsystem *subsystem);
     ...
     */
    void (*ledd_subsystem_destruct)(struct locl_subsystem *subsystem);
     ...
     * @param[in] subsystem - pointer to subsystem.
     */
    void (*ledd_subsystem_dealloc)(struct locl_subsystem *subsystem);
...
struct ledd_led_class {
     ...
     * @param[out] is_good - pointer to output bool value whether
     ...
     * @param[in] is_good - pointer whether state is good or bad
     *
     * @return 0     on success.
     * @return errno on failure.
     */
