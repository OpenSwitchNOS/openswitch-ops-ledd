...
/* Initialize ops-ledd cli node.
 */
void cli_pre_init(void)
{
    /* ops-ledd doesn't have any context level cli commands.
     * To load ops-ledd cli shared libraries at runtime,this function reuired.
     */
}

/* Initialize ops-ledd cli element.
 */
